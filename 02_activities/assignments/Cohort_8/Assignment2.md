...
```
type 1 slowly changing dimensions overwrites existing data while type 2 slowly changing dimensions does not overwrite existing data but preserves history keeping a complete record of past values
```
